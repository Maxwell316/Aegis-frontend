...
export const CONTRACT_ADDRESSES: Record<NetworkName, ContractAddresses> = {
  testnet: {
    vault: "CDWW6ZYH4UEOVR2DQEKBL742DFDR6QGVK26UOBNRBJDSXBYK2S6M7VWH",
    token: "CDWW6ZYH4UEOVR2DQEKBL742DFDR6QGVK26UOBNRBJDSXBYK2S6M7VWH",
    governance: "CDWW6ZYH4UEOVR2DQEKBL742DFDR6QGVK26UOBNRBJDSXBYK2S6M7VWH",
  },
  mainnet: {
    vault: "CAEGISTESTXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX4",
    token: "CAEGISTESTXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX4",
    governance: "CAEGISTESTXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX4",
  },
};
